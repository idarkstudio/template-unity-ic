...
var authStates = {
  ...
  states: {
    initializing: {
      on: {
        DONE: {
          ...
          actions: assign3((context, event2) => ({
            providers: event2.data.providers
          }))
        },
        DONE_AND_CONNECTED: {
          target: "connected",
          actions: [assign3((context, event2) => ({
            providers: event2.data.providers,
            activeProvider: event2.data.activeProvider,
            principal: event2.data.principal
          }))]
        },
        ERROR: {
          // ?
      ...
      invoke: {
        id: "init",
        src: (context, event2) => async (callback, onReceive) => {
          const {
            providers
          } = context;
      ...
      on: {
        ...
        SAVE_ACTOR: {
          actions: assign3((context, event2) => ({
            actors: {
              ...context.actors,
              [event2.data.canisterName]: event2.data.actor
            }
          }))
        }
      }
...
var createClient = (_ref) => {
  ...
  const rootMachine = createMachine({
    ...
    actions: {
      ...
      onConnect: (context, event2) => {
        emitter.emit("connect", event2.data);
        return assign3({
          connectingProvider: event2.data
        });
      },
      onConnecting: () => {
...
xstate/es/_virtual/_tslib.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-ZF53USC2.js.map

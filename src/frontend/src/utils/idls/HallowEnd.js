export default ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    ext_expired: IDL.Func([], [IDL.Vec(IDL.Tuple(AccountIdentifier__1, SubAccount__1))], ["query"]),
    ...
    ext_marketplaceTransactions: IDL.Func([], [IDL.Vec(Transaction)], ["query"]),
    ...
    ext_payments: IDL.Func([], [IDL.Vec(IDL.Tuple(AccountIdentifier__1, Payment))], ["query"]),
    ...
    ext_saleSettings: IDL.Func([AccountIdentifier__1], [IDL.Opt(SaleDetails)], ["query"]),
    ...
    getMetadata: IDL.Func([], [IDL.Vec(IDL.Tuple(TokenIndex, MetadataLegacy))], ["query"]),
    getMinter: IDL.Func([], [IDL.Principal], ["query"]),
    getRegistry: IDL.Func([], [IDL.Vec(IDL.Tuple(TokenIndex, AccountIdentifier__1))], ["query"]),
    getTokens: IDL.Func([], [IDL.Vec(IDL.Tuple(TokenIndex, MetadataLegacy))], ["query"]),
    ...
    listings: IDL.Func([], [IDL.Vec(IDL.Tuple(TokenIndex, Listing, MetadataLegacy))], ["query"]),
    lock: IDL.Func(
